...
<div class="dashboard">
    ...
    <header>
        ...
        <div class="left_area">
            <h3><img style="height:27px;" src="https://www.gstatic.com/images/branding/product/1x/keep_2020q4_48dp.png" alt="not" />Fund<span>oo</span></h3>
        </div>
 ...
 <i id="list"  class="fas fa-list"></i>
        ...
        <div class="right-area">
            ...
            <!-- <a href="http://localhost:3000/login" class="logout_btn"><i class="fa fa-sign-out" aria-hidden="true"></i>Signout</a> -->
        </div>
